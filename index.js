...
function mount() {
  ...
  panel.innerHTML = `<div class="ned-backdrop" data-close="panel"></div><div class="ned-dialog" role="dialog" aria-modal="true" aria-label="NPC · 사건 생성 설정">
    ...
    <section data-pane="general">
      ...
      <p class="ned-note">Jev 키는 이 브라우저의 로컬 저장소에 보관합니다. Jev 요청은 SillyTavern 내장 프록시를 사용하므로 config.yaml에서 enableCorsProxy: true로 설정하고 서버를 재시작해야 합니다. 별도 서버 플러그인은 필요하지 않습니다.</p>
